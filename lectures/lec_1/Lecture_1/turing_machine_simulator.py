...
class TuringMachineSimulator(Tk):
    def __init__(self):
        ...
        self.next_phase_button = Button(buttons, text = 'Start', width = 5,
        ...
        self.continue_button = Button(buttons, text = 'Continue',
                                      command = self.run_further, state = DISABLED)
...
class ScrollableTape(Frame):
    ...
    def determine_right_boundary(self):
        return CELL_SIZE * (max(NB_OF_CELLS_WITHOUT_SCROLL, self.max_indexes[1]) +
    ...
    def draw_minimal_tape(self):
        ...
        self.tape.create_line(-0.5 * CELL_SIZE, 0, -0.5 * CELL_SIZE, CELL_SIZE,
    ...
    def draw_horizontal_lines(self, left_boundary, right_boundary):
        self.tape.create_line(left_boundary, 0, right_boundary - left_boundary, 0,
                              width = 3, fill = CELL_COLOUR)
        self.tape.create_line(left_boundary, CELL_SIZE, right_boundary, CELL_SIZE,
                              width = 3, fill = CELL_COLOUR)
    ...
    def add_cell_to_end(self, side):
        ...
        self.lines[side][i] = self.tape.create_line(s * (i + 0.5) * CELL_SIZE, 0,
...
class Status(Canvas):
    def __init__(self, master, program):
        ...
        self.status = self.create_oval(10, 10, 20, 20, fill = NOT_RUNNING_FILL_COLOUR,
