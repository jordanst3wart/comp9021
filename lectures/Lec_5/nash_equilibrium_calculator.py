    ...
    def draw_regret_lines_and_highlight_cells(self, graph, segments, cells):
        ...
        if not segments_0[0] and segments_0[2]:
            if not segments_1[0] and segments_1[2]:
                ...
                graph.create_line(segments_1[1] * 100 + 5, 5, segments_1[1] * 100 + 5, 105,
                                  fill = CHARLIE_COLOUR, width = 2)
                graph.create_line(segments_1[1] * 100 + 5, 105, 105, 105, fill = CHARLIE_COLOUR,
                                  width = 2)
                graph.create_oval(103, 103, 107, 107, fill = NASH_COLOUR, outline = NASH_COLOUR)
                cells[1][0].config(fg = NASH_COLOUR)
            ...
            if not segments_1[0] and segments_1[2]:
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 5, 105, fill = RUTH_COLOUR,
                                  width = 2)
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 105, (1 - segments_0[1]) * 100 + 5,
                                  fill = RUTH_COLOUR, width = 2)
                graph.create_line(105, 5, 105, (1 - segments_0[1]) * 100 + 5, fill = RUTH_COLOUR,
                                  width = 2)
                graph.create_line(5, 5, 105, 5, fill = CHARLIE_COLOUR, width = 2)
                graph.create_oval(103, 3, 107, 7, fill = NASH_COLOUR, outline = NASH_COLOUR)
                cells[1][1].config(fg = NASH_COLOUR)
                ...
                graph.create_line(105, 5, 105, (1 - segments_0[1]) * 100 + 5, fill = RUTH_COLOUR,
                                  width = 2)
                graph.create_line(5, 5, 5, (1 - segments_0[1]) * 100 + 5, fill = CHARLIE_COLOUR,
                                  width = 2)
                graph.create_line(5, 5, 105, 5, fill = CHARLIE_COLOUR, width = 2)
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 5, 105, fill = NASH_COLOUR,
                                  width = 2)
                graph.create_oval(3, 103, 7, 107, fill = NASH_COLOUR, outline = NASH_COLOUR)
                graph.create_oval(103, 3, 107, 7, fill = NASH_COLOUR, outline = NASH_COLOUR)
                cells[1][1].config(fg = NASH_COLOUR)
                ...
                graph.create_line(105, 5, 105, (1 - segments_0[1]) * 100 + 5, fill = RUTH_COLOUR,
                                  width = 2)
                graph.create_line(5, 105, segments_1[1] * 100 + 5, 105, fill = CHARLIE_COLOUR,
                                  width = 2)
                graph.create_line(segments_1[1] * 100 + 5, 5, segments_1[1] * 100 + 5, 105,
                                  fill = CHARLIE_COLOUR, width = 2)
                graph.create_line(segments_1[1] * 100 + 5, 5, 105, 5, fill = CHARLIE_COLOUR, width = 2)
                ...
                graph.create_oval(segments_1[1] * 100 + 3, (1- segments_0[1]) * 100 + 3,
                                  ...
                                  fill = NASH_COLOUR, outline = NASH_COLOUR)
                cells[1][1].config(fg = NASH_COLOUR)
                cells[0][0].config(fg = NASH_COLOUR)
            elif segments_1[0] == (0, 1) and segments_1[2] == (1, 1):
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 5, 105, fill = RUTH_COLOUR,
                ...
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 105, (1 - segments_0[1]) * 100 + 5,
                                  fill = RUTH_COLOUR, width = 2)
                graph.create_line(105, 5, 105, (1 - segments_0[1]) * 100 + 5, fill = NASH_COLOUR,
                                  width = 2)
                graph.create_line(105, (1 - segments_0[1]) * 100 + 5, 105, 105, fill = CHARLIE_COLOUR,
                                  width = 2)
                graph.create_line(5, 105, 105, 105, fill = CHARLIE_COLOUR, width = 2)
                graph.create_oval(3, 103, 7, 107, fill = NASH_COLOUR, outline = NASH_COLOUR)
                graph.create_oval(103, 3, 107, 7, fill = NASH_COLOUR, outline = NASH_COLOUR)
            ...
            if not segments_1[0] and segments_1[2]:
                ...
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 105, (1 - segments_0[1]) * 100 + 5,
                                  fill = RUTH_COLOUR, width = 2)
                graph.create_line(105, (1 - segments_0[1]) * 100 + 5, 105, 105, fill = RUTH_COLOUR,
                                  width = 2)
                graph.create_line(5, 5, 105, 5, fill = CHARLIE_COLOUR, width = 2)
                graph.create_oval(3, 3, 7, 7, fill = NASH_COLOUR, outline = NASH_COLOUR)
                cells[0][1].config(fg = NASH_COLOUR)
                ...
                graph.create_line(105, (1 - segments_0[1]) * 100 + 5, 105, 105, fill = RUTH_COLOUR,
                                  width = 2)
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 5, 105, fill = CHARLIE_COLOUR,
                                  width = 2)
                graph.create_line(5, 5, 105, 5, fill = CHARLIE_COLOUR, width = 2)
                ...
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 105, (1 - segments_0[1]) * 100 + 5,
                                  fill = RUTH_COLOUR, width = 2)
                graph.create_line(105, 5, 105, (1 - segments_0[1]) * 100 + 5, fill = CHARLIE_COLOUR,
                                  width = 2)
                graph.create_line(5, 105, 105, 105, fill = CHARLIE_COLOUR, width = 2)
                graph.create_line(105, (1 - segments_0[1]) * 100 + 5, 105, 105, fill = NASH_COLOUR,
                                  width = 2)
                graph.create_oval(103, 103, 107, 107, fill = NASH_COLOUR, outline = NASH_COLOUR)
                cells[1][0].config(fg = NASH_COLOUR)
            elif not segments_1[2] and segments_1[0]:
...
class GameMatrix(Frame):
    ...
    def create_matrix(self):
        ...
        Label(self, text = 'Charlie', fg = CHARLIE_COLOUR).grid(row = 0, rowspan = 2, column = 2,
                                                                padx = 5)
