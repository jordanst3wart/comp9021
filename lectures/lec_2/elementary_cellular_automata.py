...
class ElementaryCellularAutomata(Tk):
    def __init__(self):
        ...
        Label(self, width = 9, height = 1, textvariable = self.shown_rule_number,
        ...
        self.history = Canvas(self, width = NB_OF_STEPS * 4 + 3, height = NB_OF_STEPS * 2 + 5,
    ...
    def work_from_single_1(self):
        ...
        self.history.create_rectangle(2 * NB_OF_STEPS + 3, 5, 2 * NB_OF_STEPS + 5, 7,
                                      fill = HISTORY_COLOUR)
        a = False
    ...
    def work_from_random_state(self):
        ...
        # ...
        line = [randint(0, 1) for _ in range(4 * NB_OF_STEPS - 2)], [0] * (4 * NB_OF_STEPS - 2)
